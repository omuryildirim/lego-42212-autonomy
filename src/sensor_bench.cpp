...
#if ENABLE_SENSOR_MODE

// Sensor bench mode: read the MPU-9265 IMU and VL53L8CX ToF over a shared I2C
// bus and stream snapshots over USB serial and BLE. The motor outputs are held
// inert. Active when ENABLE_SENSOR_MODE == 1.
...
// ignores commands — the data stream is one-way.
